...
const projects = [
  ...
  },
  {
    ...
    description:
      ' - A chrome extension devtool to inspect the performance of a React application',
  },
  {
  ...
  },
  {
    ...
    description:
      '	- A React component that renders a terminal on a web page with different options and plugins',
  },
]
